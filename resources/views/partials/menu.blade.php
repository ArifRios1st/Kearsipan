    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('letter_out_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.letter-outs.index") }}" class="nav-link {{ request()->is("admin/letter-outs") || request()->is("admin/letter-outs/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon far fa-envelope">

                            </i>
                            <p>
                                {{ trans('cruds.letter-out.title') }}
                            </p>
                        </a>
                    </li>
                @endcan

                @can('letter_in_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.letter-ins.index") }}" class="nav-link {{ request()->is("admin/letter-ins") || request()->is("admin/letter-ins/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-envelope">

                            </i>
                            <p>
                                {{ trans('cruds.letter-in.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
