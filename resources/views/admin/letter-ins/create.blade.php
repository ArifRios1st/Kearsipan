...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.letter-in.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('admin.letter-ins.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('sender') ? 'is-invalid' : '' }}" type="text" name="sender"
                        id="sender" value="{{ old('sender', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('received_at') ? 'is-invalid' : '' }}" type="text"
                        name="received_at" id="received_at" value="{{ old('received_at') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('disposition') ? 'is-invalid' : '' }}" type="text" name="disposition"
                        id="disposition" value="{{ old('disposition', '') }}" required>
